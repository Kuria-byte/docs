...
description: "AWO Platform Coach Discovery API endpoint"
---
...
<Info>
This endpoint provides coach discovery functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/coach-discovery" \
