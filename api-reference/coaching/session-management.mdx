...
description: "AWO Platform Session Management API endpoint"
---
...
<Info>
This endpoint provides session management functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/session-management" \
