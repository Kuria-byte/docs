...
description: "AWO Platform Progress Tracking API endpoint"
---
...
<Info>
This endpoint provides progress tracking functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/progress-tracking" \
