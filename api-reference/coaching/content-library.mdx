...
description: "AWO Platform Content Library API endpoint"
---
...
<Info>
This endpoint provides content library functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/content-library" \
