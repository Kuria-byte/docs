---
title: "Logout"
description: "AWO Platform Logout API endpoint"
---
...
<Info>
This endpoint provides logout functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/logout" \
