---
title: "Preferences"
description: "AWO Platform Preferences API endpoint"
---
...
<Info>
This endpoint provides preferences functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/preferences" \
