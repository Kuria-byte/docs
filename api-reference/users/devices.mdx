---
title: "Devices"
description: "AWO Platform Devices API endpoint"
---
...
<Info>
This endpoint provides devices functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/devices" \
