...
description: "AWO Platform Balance Inquiries API endpoint"
---
...
<Info>
This endpoint provides balance inquiries functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/balance-inquiries" \
