...
description: "AWO Platform Transaction Sync API endpoint"
---
...
<Info>
This endpoint provides transaction sync functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/transaction-sync" \
