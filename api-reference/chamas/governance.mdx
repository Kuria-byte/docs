---
title: "Governance"
description: "AWO Platform Governance API endpoint"
---
...
<Info>
This endpoint provides governance functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/governance" \
