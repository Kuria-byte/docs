---
title: "Reporting"
description: "AWO Platform Reporting API endpoint"
---
...
<Info>
This endpoint provides reporting functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/reporting" \
