...
description: "AWO Platform Push Notifications API endpoint"
---
...
<Info>
This endpoint provides push notifications functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/push-notifications" \
