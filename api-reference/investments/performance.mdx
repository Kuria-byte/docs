---
title: "Performance"
description: "AWO Platform Performance API endpoint"
---
...
<Info>
This endpoint provides performance functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/performance" \
