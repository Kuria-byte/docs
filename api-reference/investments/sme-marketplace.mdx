...
description: "AWO Platform Sme Marketplace API endpoint"
---
...
<Info>
This endpoint provides sme marketplace functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/sme-marketplace" \
