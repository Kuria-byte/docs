---
title: "Mobile Money"
description: "AWO Platform Mobile Money API endpoint"
---
...
<Info>
This endpoint provides mobile money functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/mobile-money" \
