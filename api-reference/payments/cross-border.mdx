---
title: "Cross Border"
description: "AWO Platform Cross Border API endpoint"
---
...
<Info>
This endpoint provides cross border functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/cross-border" \
