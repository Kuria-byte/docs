---
title: "Score Events"
description: "AWO Platform Score Events API endpoint"
---
...
<Info>
This endpoint provides score events functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/score-events" \
