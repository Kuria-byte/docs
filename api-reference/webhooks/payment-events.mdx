...
description: "AWO Platform Payment Events API endpoint"
---
...
<Info>
This endpoint provides payment events functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/payment-events" \
