---
title: "Auto Savings"
description: "AWO Platform Auto Savings API endpoint"
---
...
<Info>
This endpoint provides auto savings functionality for the AWO Platform.
</Info>
...
```bash
curl -X POST "https://api.awo-platform.com/v1/auto-savings" \
