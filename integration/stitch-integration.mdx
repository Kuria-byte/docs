...
description: "AWO Platform stitch integration integration guide"
---
...
<Info>
This guide covers stitch integration integration with the AWO Platform.
</Info>
...
```typescript
// Integration example
import { StitchIntegrationClient } from '@awo-platform/integrations';

const client = new StitchIntegrationClient({
