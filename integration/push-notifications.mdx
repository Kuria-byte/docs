...
<Steps>
  <Step title="Development Environment">
    ...
    • iOS/Android testing devices or simulators  
    • AWO mobile app repository access
  </Step>
  <Step title="Platform Accounts">
    • Apple Developer account (for iOS)  
    • Google Firebase project (for Android)  
    • Expo account for push notification service  
    • AWO backend with notification service setup
  </Step>
      ...
      <View style={styles.overlay}>
        <View style={styles.modal}>
          ...
          <View style={styles.benefitsList}>
            <Text style={styles.benefit}>• Transaction confirmations</Text>
            <Text style={styles.benefit}>• DIVA score updates</Text>
            <Text style={styles.benefit}>• Chama activity alerts</Text>
            <Text style={styles.benefit}>• Investment opportunities</Text>
          </View>
