---
title: "Flutterwave Setup"
description: "AWO Platform flutterwave setup integration guide"
---
...
<Info>
This guide covers flutterwave setup integration with the AWO Platform.
</Info>
...
```typescript
// Integration example
import { FlutterwaveSetupClient } from '@awo-platform/integrations';

const client = new FlutterwaveSetupClient({
