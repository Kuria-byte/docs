---
title: "Open Banking"
description: "AWO Platform open banking integration guide"
---
...
<Info>
This guide covers open banking integration with the AWO Platform.
</Info>
...
```typescript
// Integration example
import { OpenBankingClient } from '@awo-platform/integrations';
