---
title: "Basic Chama"
description: "AWO Platform basic chama core functionality"
---
...
<Info>
Basic Chama is a core feature of the AWO Platform, designed to support financial inclusion for African women.
</Info>
...
const response = await awo.basicchama.method();
```
