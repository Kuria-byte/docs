---
title: "Mobile Money"
description: "AWO Platform mobile money core functionality"
---
...
<Info>
Mobile Money is a core feature of the AWO Platform, designed to support financial inclusion for African women.
</Info>
...
const response = await awo.mobilemoney.method();
```
