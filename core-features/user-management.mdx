...
description: "AWO Platform user management core functionality"
---
...
<Info>
User Management is a core feature of the AWO Platform, designed to support financial inclusion for African women.
</Info>
...
const response = await awo.usermanagement.method();
```
