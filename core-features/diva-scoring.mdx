---
title: "Diva Scoring"
description: "AWO Platform diva scoring core functionality"
---
...
<Info>
Diva Scoring is a core feature of the AWO Platform, designed to support financial inclusion for African women.
</Info>
...
const response = await awo.divascoring.method();
```
