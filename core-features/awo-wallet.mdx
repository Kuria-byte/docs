---
title: "Awo Wallet"
description: "AWO Platform awo wallet core functionality"
---
...
<Info>
Awo Wallet is a core feature of the AWO Platform, designed to support financial inclusion for African women.
</Info>
...
const response = await awo.awowallet.method();
```
