---
title: "Rtsm Assessment"
description: "AWO Platform rtsm assessment core functionality"
---
...
<Info>
Rtsm Assessment is a core feature of the AWO Platform, designed to support financial inclusion for African women.
</Info>
...
const response = await awo.rtsmassessment.method();
```
